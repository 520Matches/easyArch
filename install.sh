...
pacstrap /mnt base base-devel linux linux-firmware iwd dhcp wpa_supplicant grub acpid xorg xorg-drivers alsa-utils pulseaudio pulseaudio-alsa wireless_tools networkmanager network-manager-applet sudo linux-headers dosfstools efibootmgr
